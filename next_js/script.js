...
const imageData = {
    ...
    Après validation de votre commande, vous serez contactés pour plus d’informations.</p>
    ...
    item2: {
        ...
        `
        <div class="des-styles">
        <h2>Porte Pleine 1 Batt BE4 :</h2>
    <p>Porte Pleine 1 Batt BE4 en fer découpé au laser
        ...
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    item3: {
        ...
        description: `
        <div class="des-styles">
        <h2>Porte Plexiglass 1 Batt BE4</h2>
    <p>Porte Plexiglass 1 Batt BE4 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Porte Plexiglass 1 Batt BE4</td>
    ...
    item4: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Porte Vitrée 1 Batt BE4 :</h2>
    <p>en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    item5: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Porte Grille 1 Batt BE6 :</h2>
    <p>Porte Grille 1 Batt BE6 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    item6: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Porte Pleine 1 Batt BE6 :</h2>
    <p>Porte Pleine 1 Batt BE6 en fer découpé au laser      
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.       
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.      
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.        
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          ...
          <tr>
            <td>Fermeture intérieur</td>
            <td>Fermeture intérieur	Tôle 15/10 1.5mm</td>
          </tr>
          <tr>
            <td>Peinture </td>
            <td>Antirouille sur l'ensemble</td>
    ...
    item7: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Porte Plexiglass 1 Batt BE6 :</h2>
    <p>Porte Plexiglass 1 Batt BE6 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Porte Plexiglass 1 Batt BE6</td>
    ...
    item8: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Porte Vitrée 1 Batt BE6 :</h2>
    <p>Porte Vitrée 1 Batt BE6 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    item11: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Porte Plexiglass 1 Batt BE8  :</h2>
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Porte Plexiglass 1 Batt BE8  </td>
    ...
    item12: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Porte Vitrée 1 Batt BE8  :</h2>
    <p>Porte Vitrée 1 Batt BE8  en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
