...
const imageData = {
    ...
    <h2>Porte Grille 2 Batt BE4 :</h2>
    <p>Porte Grille 2 Batt BE4 en fer découpé au laser
    ...
    item3: {
        ...
        description: `
        <div class="des-styles">
        <h2>Porte Plexiglass 2 Batt BE4</h2>
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Porte Plexiglass 2 Batt BE4</td>
    ...
    item7: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Porte Plexiglass 2 Batt BE6 :</h2>
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Porte Plexiglass 2 Batt BE6</td>
