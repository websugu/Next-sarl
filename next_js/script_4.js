...
const imageData = {
    ...
    <h2>Portail Grille 2 Batt BE4 :</h2>
    <p>Portail Grille 2 Batt BE4 en fer découpé au laser
...
Après validation de votre commande, vous serez contactés pour plus d’informations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          ...
          <td>Portail Grille 2 Batt BE4</td>
         
        </tr>
        <tr>
          <td>Largeur de la porte </td>
          <td>Personnalisée/250 à 600 cm (+/- 10 cm)</td>
        </tr>
        <tr>
    ...
    item2: {
        ...
        `
        <div class="des-styles">
        <h2>Portail Grille Coulissant BE4 :</h2>
    <p>Portail Grille Coulissant BE4 en fer découpé au laser
Nos portillons métalliques sont des portes avec des caractéristiques et des performances supérieures aux portillons dis standards. Multi-usages par définition, ceux-ci  peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
Nos portillons d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre 
maison.
A la fois élément de protection, mais aussi de décoration, nos portillons allient la solidité et le raffinement.
...
Après validation de votre commande, vous serez contactés pour plus d’informations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Grille Coulissant BE4</td>
    ...
    item3: {
        ...
        description: `
        <div class="des-styles">
        <h2>Portail Plein 2 Batt BE4 :</h2>
    <p>Portail Plein 2 Batt BE4 en fer découpé au laser
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plein 2 Batt BE4</td>
    ...
    item4: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plein Coulissant BE4 :</h2>
    <p> Portail Plein Coulissant BE4 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plein Coulissant BE4</td>
    ...
    item5: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plexiglass 2 Batt BE4 :</h2>
    <p>Portail Plexiglass 2 Batt BE4 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plexiglass 2 Batt BE4</td>
    ...
    item6: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plexiglass Coulissant BE4 :</h2>
    <p>Portail Plexiglass Coulissant BE4 en fer découpé au laser      
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.       
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.      
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.        
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plexiglass Coulissant BE4</td>
    ...
    item7: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Grille 2 Batt BE6 :</h2>
    <p>Portail Grille 2 Batt BE6 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Grille 2 Batt BE6</td>
    ...
    item9: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plein 2 Batt BE6 :</h2>
    <p>Portail Plein 2 Batt BE6 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plein 2 Batt BE6 </td>
    ...
    item10: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plein Coulissant BE6 :</h2>
    <p>Portail Plein Coulissant BE6 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plein Coulissant BE6</td>
    ...
    item11: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plexiglass 2 Batt BE6 :</h2>
    <p>Portail Plexiglass 2 Batt BE6 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plexiglass 2 Batt BE6 </td>
    ...
    item12: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plexiglass Coulissant BE6 :</h2>
    <p>Portail Plexiglass Coulissant BE6 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plexiglass Coulissant BE6 </td>
    ...
    item13: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Grille 2 Batt BE8 :</h2>
    <p>Portail Grille 2 Batt BE8 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Grille 2 Batt BE8 </td>
    ...
    item14: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Grille Coulissant BE8 :</h2>
    <p>Portail Grille Coulissant BE8 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Grille Coulissant BE8 </td>
    ...
    item15: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plein 2 Batt BE8 :</h2>
    <p>Portail Plein 2 Batt BE8 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plein 2 Batt BE8 </td>
    ...
    item16: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plein Coulissant BE8 :</h2>
    <p>Portail Plein Coulissant BE8 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plein Coulissant BE8</td>
    ...
    item17: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plexiglass 2 Batt BE8 :</h2>
    <p>Portail Plexiglass 2 Batt BE8 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plexiglass 2 Batt BE8 </td>
    ...
    item9: {
        ...
        description: `
         ...
         <div class="des-styles">
        <h2>Portail Plexiglass Coulissant BE8 :</h2>
    <p>Portail Plexiglass Coulissant BE8 en fer découpé au laser
        Nos portes métalliques sont des portes avec des caractéristiques et des performances supérieures aux portes dites standards. Multi-usages par définition, celles-ci peuvent être posées dans Établissements du Public, les collectivités, dans des bureaux, mais aussi les bâtiments d'habitation et commerciaux.
        Nos portes d’accès en fer découpé au laser reflètent votre personnalité et donne le ton à l’accueil dans votre maison.
        A la fois élément de protection, mais aussi de décoration, nos portes allient la solidité et le raffinement.
        C’est pourquoi elles sont des réalisations qui s’inscrivent dans la durée tout comme nos autres créations.
    ...
    <table style="width:100%" >
        ...
        <tr>
          <td>Nom du production</td>
          <td>Portail Plexiglass Coulissant BE8 </td>
